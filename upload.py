        ...
        create_dashboard(c, cache)
{
    ...
    "query": {
        "source-query": {
            "source-table": "card__132",
            "aggregation": [["count"]],
            "breakout": [
                ["field", "color", {"base-type": "type/Text"}],
                ["field", "size", {"base-type": "type/Text"}],
                ["field", "cut", {"base-type": "type/Text"}],
                ["field", "shape", {"base-type": "type/Text"}],
                ["field", "fluorescence", {"base-type": "type/Text"}],
                ["field", "lab", {"base-type": "type/Text"}],
                ["field", "polish", {"base-type": "type/Text"}],
                ["field", "clarity", {"base-type": "type/Text"}],
                ["field", "event", {"base-type": "type/Text"}],
                ["field", "country_code", {"base-type": "type/Text"}],
                [
                    "field",
                    "timestamp",
                    {
                ...
                ["field", "company_name", {"base-type": "type/Text"}],
                [
                    "field",
                    "app_id_id",
                    {
